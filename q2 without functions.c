        ...
        while(turncounter<totalturns)
        {
            ...
            if (turncounter%2==0)
            {
                    ...
                    for (j=1;j<c;j+=2)
                        {
                            ...
                            {
                                int countvertical=0;
                                // will increment when the condition is met and when the value is 4 winning condition is met
                ...
                if (r==5)
                {
                    ...
                    {
                        j=1;
                        if (a[i][j]==a[i][j+2]==a[i][j+4]==a[i][j+6]==a[i][j+8])
                        {
                           flag=1;
                        }
                    }
                    ...
                    for (j=1;j<c;j+=2)
                        ...
                        // left to right diagonal check
                        if (a[0][1]==a[1][3]==a[2][5]==a[3][7]||a[1][3]==a[2][5]==a[3][7]==a[4][9]||a[1][1]==a[2][3]==a[3][5]==a[4][7]||a[0][3]==a[1][5]==a[2][7]==a[3][9])
                        {
                            flag==1;
                        }

                        // right to left diagonal check
                        if (a[0][7]==a[1][5]==a[2][3]==a[3][1] || a[0][9]==a[1][7]==a[2][5]==a[3][3] || a[1][7]==a[2][5]==a[3][3]==a[4][1] || a[1][9]==a[2][7]==a[3][5]==a[4][3])
                        {
                            flag==1;
                        }
                ...
                if (r==6)
                {
                    ...
                    {
                        j=1;
                        if (a[i][j]==a[i][j+2]==a[i][j+4]==a[i][j+6]==a[i][j+8]==a[i][j+10])
                        {
                           flag=1;
                        }
                    }
